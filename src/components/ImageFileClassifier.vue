...
<template>
  <div class="mt-4 text-md text-stone-900 dark:text-slate-100">
    <div class="flex flex-wrap justify-center mx-auto w-full">
      <router-link
        to="/"
        class="cursor-pointer sm:px-6 py-3 w-1/2 sm:w-auto justify-center border-b-2 title-font font-medium inline-flex items-center leading-none border-stone-500 dark:border-slate-100 text-stone-900 dark:text-slate-100 tracking-wider rounded-t"
      >
      ...
      <router-link
        to="/webcam"
        class="cursor-pointer sm:px-6 py-3 w-1/2 sm:w-auto justify-center border-b-2 title-font font-medium inline-flex items-center leading-none border-gray-300 hover:border-gray-400 dark:border-gray-600 dark:hover:border-gray-400 text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-300 transition tracking-wider"
      >
